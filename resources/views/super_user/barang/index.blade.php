...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="mb-4">
            <a href="{{ route('su.barang.create') }}" class="bg-teal-500 text-white px-4 py-2 rounded-md">Tambah Barang</a>
        </div>
            ...
            <tbody>
                @foreach ($barang as $item)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b text-sm">
                            <a href="{{ route('su.barang.edit', $item->br_kode) }}" class="text-blue-500">Edit</a>
                            <form action="{{ route('su.barang.destroy', $item->br_kode) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
