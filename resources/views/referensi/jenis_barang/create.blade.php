...
@section('content')
    <div class="container mx-auto p-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Tambah Jenis Barang</h2>

        <a href="{{ route('jenis_barang.index') }}" class="text-gray-600 hover:text-gray-800 inline-block mb-4">
            &larr; Kembali
        </a>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <form action="{{ route('jenis_barang.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="jns_brg_nama" name="jns_brg_nama"
