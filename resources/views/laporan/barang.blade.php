...
<div class="container mx-auto py-8 px-4">
    ...
    <!-- Form Filter Tanggal -->
    <form action="{{ route('laporan.barang') }}" method="GET" class="mb-6 flex items-center space-x-4">
    ...
    <div class="overflow-x-auto bg-white shadow-lg rounded-lg">
        <table class="min-w-full table-auto">
            ...
            <tbody class="divide-y divide-teal-200">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-800">Tidak ada barang yang ditemukan untuk rentang tanggal ini.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
